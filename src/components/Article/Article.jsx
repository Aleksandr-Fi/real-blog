  ...
  return (
    <div className={classes.Article}>
      <div className={classes.Article__content}>
        <h1 className={classes.Article__title}>Some article title</h1>
        <div>tagsList</div>
      ...
      <div className={classes.Article__info}>
        <h1 className={classes['Article__author-name']}>John Doe</h1>
        <label className={classes.Article__data}>March 5, 2020 </label>
        <img
